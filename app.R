...
shinyApp(
ui = dashboardPage(
  dashboardHeader(title = "stock portfolio analysis"),
  dashboardSidebar(
    sidebarMenu(
  ...
  dashboardBody(
    h4("after scanning all stock chart from Jan 2020 to July 2020,we select three stock to invest diversely.First we draw the candlestick plot of three stock charts. And then we set the proportion of three stock to invest cash,And observe the revenue in each month after July 2020"),
    tabItems(
